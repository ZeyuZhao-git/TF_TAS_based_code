...
class PatchembedSuper(nn.Module):
    ...
    def forward(self, x):
        ...
        #     float_bias = self.sampled_bias
        #     float_weight = self.sampled_weight
        #     self.sampled_bias = self.sampled_bias.double()
        #     self.sampled_weight = self.sampled_weight.double()
        ...
        # self.sampled_bias = float_bias
        # self.sampled_weight = float_weight
        if self.scale:
